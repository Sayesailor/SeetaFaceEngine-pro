 ...
 *
 * This file is an example of how to use SeetaFace engine for face alignment,
 *the
...
int main(int argc, char** argv)
{
  ...
  seeta::FaceDetection
detector("../../../FaceDetection/model/seeta_fd_frontal_v1.0.bin");
  ...
  seeta::FaceAlignment point_detector((MODEL_DIR +
"seeta_fa_v1.1.bin").c_str());
...
cvPoint(faces[0].bbox.x + faces[0].bbox.width - 1, faces[0].bbox.y +
faces[0].bbox.height - 1), CV_RGB(255, 0, 0));
