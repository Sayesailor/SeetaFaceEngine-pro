...
class SIFT {
   public:
    ...
    /** Initialize the SIFT extractor.
            ...
            */
    void InitSIFT(int im_width, int im_height, int patch_size,
                  int grid_spacing);
    ...
    */
    void filter2(double* gray_im, double* kernel, int kernel_size,
                 double* filter_im);
    ...
    */
    void SparseFilter2(double* gray_im, double* kernel, int kernel_size,
                       double* filter_im);
